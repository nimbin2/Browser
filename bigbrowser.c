/*
 * bigbrowser - WebKitGTK 6.0 (GTK4) page viewer for camera and streaming
 *
...
static const BrowserApp bigbrowser = {
    .tagline        = "WebKitGTK 6.0 / GTK4 page viewer with camera and streaming fixes",
    .default_title  = "Bigbrowser",
    .default_app_id = "bigbrowser",
...
{
    return browser_main (argc, argv, &bigbrowser);
}
